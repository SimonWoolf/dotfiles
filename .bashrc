...
alias grep="grep -i --color=auto --text"
...
alias clpo="CLAUDE_CONFIG_DIR="/home/simon/.claude-personal" claude --enable-auto-mode --allow-dangerously-skip-permissions --model opus "
